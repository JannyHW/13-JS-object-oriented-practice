...
function Dog(obj) {
  ...
  obj !== undefined && obj.color !== undefined
    ? (this.color = obj.color) //#2
    : (this.color = null);
  obj !== undefined && obj.hungry !== undefined
    ? (this.hungry = obj.hungry) //#3
    : (this.hungry = true);
}

function Human(obj) {
  this.pet = (obj) => (obj.status = "happy"); //#1
  this.feed = (obj) => (obj.hungry = false); //#4
  obj !== undefined ? (this.cool = obj.cool) : (this.cool = false); //#6
}
